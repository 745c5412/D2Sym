...
namespace D2Sym.D2O
{
    ...
    public class D2OSynchroniser
    {
        ...
        /// <summary>
        /// => nul, changer les params de la query SQL
        /// </summary>
        ...
        /// <summary>
        /// => remplacer mediumtext par le type SQL correspondant
        /// </summary>
        ...
        public static D2OSyncQueries[] GetAllD2OsQueries(bool convertlang)
        {
            ...
            {
                syncQueries.Add(GetSyncQueries(Type.GetType("D2Sym.Classes." + d2o),convertlang));
        ...
        {
            return GetD2OValues(Type.GetType("D2Sym.Classes." + d2oName),convertlang);
        }
        ...
        {
            return GetD2OFields(Type.GetType("D2Sym.Classes." + d2oName));
        }
